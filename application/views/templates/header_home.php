...
<nav class="navbar navbar-expand-lg navbar-red bg-red fixed-top">
    <a class="navbar-brand" href="<?= base_url();?>pasien/home"><img src="http://localhost/telkomedika/assets/gambar/jary.jpg" style="width:40px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('pasien/home'); ?>">Beranda</a>
            </li>
            <li class="nav-item">
            <span class="nav-link">|</span>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link" href="<?php echo base_url('pasien/PilihJadwalPeriksa'); ?>">Pilih Jadwal Periksa</a>
            </li>
            <li class="nav-item">
                <span class="nav-link">|</span>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link" href="<?php echo base_url('pasien/LihatJadwalPraktekDokter'); ?>">Jadwal Praktek Dokter</a>
            </li>
        </ul>
